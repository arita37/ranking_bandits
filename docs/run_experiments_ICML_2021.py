...
nb_iter = 10**2                        # total number of iterations
...
for env_name in env_names:
    ...
    suffix = f'__games_{nb_iter}_nb_trials_-1_record_length_{nb_games}_games.gz'
    ...
    plt.grid(True)
    plt.xscale('log')
    plt.savefig(f'{path_to_curves}/{env_name}.png', bbox_inches='tight', pad_inches=0)
